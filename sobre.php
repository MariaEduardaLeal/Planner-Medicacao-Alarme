...
<body>
    <div class="container">
        ...
        <div class="box-one">
            <div class="quem-somos-e-objetivos">
                <img src="img/icon-nosso-objetivo.svg" class="imagem-icon" id="imagens">
                <h2 id="nois">Quem somos</h2>
                ...
                <img src="img/icon-quem-somos.svg" id="imagens">
            ...
            <img src="img/icon-contatos.svg" id="imagens">
    ...
    <ul class="lista-contato">
        ...
        <li class="nome"><img src="img/icon-usuario-dependente-1.svg" class="foto-perfil">Jéssica Raissa</li>
        <li><a href="mailto:jessicaraissapessoa@gmail.com?subject=Jéssica você está muito bonita hoje&jessicaraissapessoa@gmail.com"><img src="img/icon-gmail.svg"> Gmail</a></li>
        <li><a href="https://www.linkedin.com/in/jessicaraissapessoa/" target="_blank"><img src="img/icon-linkedin.svg"> Linkedin</a></li>
        <li><a href="https://github.com/jessicaraissapessoa" target="_blank"><img src="img/icon-github.svg"> GitHub</a></li>
    </ul>
    
    <ul class="lista-contato">
        
        <li class="nome"><img src="img/icon-usuario-dependente-1.svg" class="foto-perfil"> Maria Eduarda</li>
        <li><a href="mailto:eduardaleal753@gmail.com?subject=Jéssica você está muito bonita hoje&eduardaleal753@gmail.com"><img src="img/icon-gmail.svg"> Gmail</a></li>
        <li><a href="https://www.linkedin.com/in/maria-eduarda-de-medeiros-leal-716601235/" target="_blank"><img src="img/icon-linkedin.svg"> Linkedin</a></li>
        <li><a href="https://github.com/MariaEduardaLeal" target="_blank"><img src="img/icon-github.svg"> GitHub</a></li>
    </ul>

    <ul class="lista-contato">
        <li class="nome" class="foto-perfil"><img src="img/icon-usuario-dependente-1.svg"> Patreze Leal</li>
        <li><a href="mailto:patrezeleal@gmail.com?subject=Jéssica você está muito bonita hoje&patrezeleal@gmail.com"><img src="img/icon-gmail.svg"> Gmail</a></li>
        <li><a href="https://www.linkedin.com/in/patreze-leal-medeiros-64b656235/" target="_blank"><img src="img/icon-linkedin.svg"> Linkedin</a></li>
        <li><a href="https://github.com/PatrezeLeal" target="_blank"><img src="img/icon-github.svg"> GitHub</a></li>
    </ul>
</div>
