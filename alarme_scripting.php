...
// Verificar se a opção padrão "Selecione" foi selecionada nos campos "Dosagem" e "Concentração"
if (mysqli_num_rows($resultado_medicamento) > 0) {
  ...
  for ($i = 0; $i < $duracao; $i++) {
    ...
    for ($j = 0; $j < $intervalo_horas; $j++) {
      ...
      VALUES (null, $id_medicamento, '$data_alarme $hora_alarme', '$opcao', '$num_dosagem$dosagem', '$num_concentracao$concentracao')";
